...
void AddCoSimIOModelPartToPython(pybind11::module& m)
{
    ...
    py::enum_<CoSimIO::ElementType>(m,"ElementType")
        .values("Hexahedra3D20",        CoSimIO::ElementType::Hexahedra3D20)
        .values("Hexahedra3D27",        CoSimIO::ElementType::Hexahedra3D27)
        .values("Hexahedra3D8",         CoSimIO::ElementType::Hexahedra3D8)
        .values("Prism3D15",            CoSimIO::ElementType::Prism3D15)
        .values("Prism3D6",             CoSimIO::ElementType::Prism3D6)
        .values("Quadrilateral2D4",     CoSimIO::ElementType::Quadrilateral2D4)
        .values("Quadrilateral2D8",     CoSimIO::ElementType::Quadrilateral2D8)
        .values("Quadrilateral2D9",     CoSimIO::ElementType::Quadrilateral2D9)
        .values("Quadrilateral3D4",     CoSimIO::ElementType::Quadrilateral3D4)
        .values("Quadrilateral3D8",     CoSimIO::ElementType::Quadrilateral3D8)
        .values("Quadrilateral3D9",     CoSimIO::ElementType::Quadrilateral3D9)
        .values("Tetrahedra3D10",       CoSimIO::ElementType::Tetrahedra3D10)
        .values("Tetrahedra3D4",        CoSimIO::ElementType::Tetrahedra3D4)
        .values("Triangle2D3",          CoSimIO::ElementType::Triangle2D3)
        .values("Triangle2D6",          CoSimIO::ElementType::Triangle2D6)
        .values("Triangle3D3",          CoSimIO::ElementType::Triangle3D3)
        .values("Triangle3D6",          CoSimIO::ElementType::Triangle3D6)
        .values("Line2D2",              CoSimIO::ElementType::Line2D2)
        .values("Line2D3",              CoSimIO::ElementType::Line2D3)
        .values("Line3D2",              CoSimIO::ElementType::Line3D2)
        .values("Line3D3",              CoSimIO::ElementType::Line3D3)
        .values("Point2D",              CoSimIO::ElementType::Point2D)
        .values("Point3D",              CoSimIO::ElementType::Point3)
        ;
}
