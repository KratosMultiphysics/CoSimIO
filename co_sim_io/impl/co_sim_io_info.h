...
//     TDataType GetValue(const std::string& rKey)
//     {
//         KRATOS_CO_SIM_ERROR_IF_NOT(HasValue<TDataType>(rKey)) << "Does not exist" << std::endl;
//         KRATOS_CO_SIM_ERROR_IF_NOT(mOptions[rKey].first(), typeid(TDataType)) << "Wrong DataType!";
...
//     {
//         const bool has_value = mOptions.count(rKey)>0;
//         if (has_value) {
//             KRATOS_CO_SIM_ERROR_IF_NOT(mOptions[rKey].first(), typeid(TDataType)) << "Wrong DataType!";
//         }
