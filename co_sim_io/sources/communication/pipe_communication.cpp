...
{
    #ifndef CO_SIM_IO_COMPILED_IN_WINDOWS
    return PIPE_SIZE/2; // assuming that both pipes have the same size => ensured in CTor // not using the entire buffer size to increase stability of data exchange
    #else
    return 0;
    #endif
}
