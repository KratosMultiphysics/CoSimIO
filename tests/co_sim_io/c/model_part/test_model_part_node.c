...
int main(int argc, const char** argv)
{
    ...
    CoSimIO_Node node_1, node_2, node_3, node_1_by_index, node_1_by_id, node_2_by_index, node_2_by_id, node_3_by_index, node_3_by_id;
    int node_1_id = 3;
    int node_2_id = 8;
    int node_3_id = 16;
    ...
    node_1 = CoSimIO_ModelPart_CreateNewNode(
        model_part,
        node_1_id,
        coords_1[0],
        coords_1[1],
    ...
    node_2 = CoSimIO_ModelPart_CreateNewNode(
        model_part,
        node_2_id,
        coords_2[0],
        coords_2[1],
    ...
    node_3 = CoSimIO_ModelPart_CreateNewNode(
        model_part,
        node_3_id,
        coords_3[0],
        coords_3[1],
    ...
    node_1_by_index = CoSimIO_ModelPart_GetNodeByIndex(model_part, 0);
    ...
    node_1_by_id = CoSimIO_ModelPart_GetNodeById(model_part, node_1_id);
    ...
    node_2_by_index = CoSimIO_ModelPart_GetNodeByIndex(model_part, 1);
    ...
    node_2_by_id = CoSimIO_ModelPart_GetNodeById(model_part, node_2_id);
    ...
    node_3_by_index = CoSimIO_ModelPart_GetNodeByIndex(model_part, 2);
    ...
    node_3_by_id = CoSimIO_ModelPart_GetNodeById(model_part, node_3_id);
