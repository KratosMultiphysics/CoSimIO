...
int main()
{
    ...
    fct_info.Set("connection_name", connection_name);

    fct_info.Set("function_name", "AdvanceInTime");
    CoSimIO::Register(fct_info, std::function<CoSimIO::Info(const CoSimIO::Info&)>([&connection_name](const CoSimIO::Info& I_Info) {
        CoSimIO::Info info;
    ...
    run_info.Set("connection_name", connection_name);
